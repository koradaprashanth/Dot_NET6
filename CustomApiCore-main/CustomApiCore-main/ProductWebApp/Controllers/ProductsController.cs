...
namespace ProductWebApp.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(PCNWebPublicContext context)
        {
            _context = context;
        }
        ...
        {
            var pCNWebPublicContext = _context.Products.Include(p => p.Brand).Include(p => p.Category);
            return View(await pCNWebPublicContext.ToListAsync());
        }
